...
_MESSAGE_TYPES = frozenset(
    [
        ...
        "psychoarchaeology played",
        "public objective revealed",
        "quash used",
        "reclamation used",
        "relic card drawn",
        "relic card gained",
        "relic fragments gained",
        "relic fragments played",
        ...
        "the atrament played",
        "the codex played",
        "the crown of emphidia played",
        "the crown of emphidia purged",
        "the inferno used",
        "tie broken",
